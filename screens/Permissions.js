...
const PermissionsScreen = ( props ) => {
    ...
    if(allPermissions){
        ...
        if(!props.route.params.existUser){
            props.navigation.navigate('Otp',{mobile:props.route.params.mobile, tempAuthToken:props.route.params.tempAuthToken,verification_key:props.route.params.verification_key})
        } else {
            props.navigation.navigate('Home',{mobile:props.route.params.mobile, tempAuthToken:props.route.params.tempAuthToken,verification_key:props.route.params.verification_key})
        }
    } else {
