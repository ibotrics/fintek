...
const HomeScreen = ({navigation}) => {
  ...
  const renderItem = ({item}) => (
    <View
      ...
      <ImageBackground
        style={{height: 15, width: 72, marginLeft: -25, alignSelf: 'center'}}
        resizeMode="contain"
        source={item.badge}>
        <Text
          style={{
  ...
  return (
    <SafeAreaView style={{paddingHorizontal: 20, backgroundColor: '#f3f4f5'}}>
      <View
        ...
        />
        <Image
          style={{height: 14, width: 14, borderRadius: 14}}
      ...
      <View>
        <Image
          ...
          resizeMode="contain"
          source={require('../Images/discover_card.png')}
        />
        <View
          style={{
            flexDirection: 'row',
      ...
      <View
        ...
        <Text style={{fontSize: 16, color: '#6f7276', fontWeight: '500'}}>
          Shopping
        </Text>
