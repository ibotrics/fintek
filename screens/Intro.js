...
const slides = [
  {
    ...
    title: (
      <View>
        <Text style={{
          marginLeft: 24,
          fontSize: RFValue(25,680), fontWeight: 'bold', color: "#000000"
        }}>One Place</Text>
        <Text style={{
          marginLeft: 24,
          fontSize: RFValue(25,680), fontWeight: 'bold', color: "#000000"
        }}>for <Text style={{ color: "#2c64e3", fontWeight: 'bold' }}>Everything</Text></Text>
      </View>
    ),
  ...
  },
  {
    ...
    title: (<View>
      ...
      <Text style={{
        marginLeft: 24,
        fontSize: RFValue(25,680), fontWeight: 'bold',
        color: "#000000"
      }}>way to <Text style={{ color: "#2c64e3", fontWeight: 'bold' }}>Shop</Text></Text>
    </View>
    ),
    buleText: 'stop',
  ...
  },
  {
    ...
    title: (<View>
      <Text style={{
        marginLeft: 24,
        fontSize: RFValue(25,680), fontWeight: 'bold', color: "#000000"
      }}>Pay at Checkout</Text>
      <Text style={{
        marginLeft: 24,
        fontSize: RFValue(25,680), fontWeight: 'bold', color: "#000000"
      }}>or get <Text style={{ color: "#2c64e3", fontWeight: 'bold' }}>Instant Cash Loan</Text></Text>
    </View>
    ),
          ...
          <ScrollView>
            <View style={styles.container}>
              <View style={{ height: Dimensions.get('window').height * 0.5 }}>
                <Image style={styles.imges} source={item.image} resizeMode="contain" />
              </View>
              <View style={{flexDirection:"column", justifyContent:"space-between", height:Dimensions.get('window').height>700 ?Dimensions.get('window').height * 0.33:Dimensions.get('window').height * 0.3}}>
  ...
  _renderNextButton = () => {
    return (
      <View
        ...
        <Text style={{
          color: '#ffffff', fontWeight: 'bold', justifyContent: 'center',
          alignItems: 'center', alignSelf: "center",
        }}>{this.state.nextTitle}</Text>
  ...
  _renderSkipButton = () => {
    return (
      <TouchableOpacity>
        <View
          style={{
            alignItems: "flex-end", alignSelf: "flex-end", margin: 20, fontWeight: "bold", width: 50, height: 20
          }}>
...
console.log("device heigh", Dimensions.get('window').height, Dimensions.get('window').height)
    return <AppIntroSlider
      ...
      activeDotStyle={{ width: 17, backgroundColor: "#000000", height: 5, fontWeight: "bold", marginTop: 10 }}
...
const styles = StyleSheet.create({
  ...
  skip: { alignItems: "flex-end", alignSelf: "flex-end", margin: 20, fontWeight: "bold", width: 50, height: 20 },
  buttonContainer: {
    height: 50,
    flexDirection: 'row',
    justifyContent: 'center',
