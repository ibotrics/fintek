...
class UserDetailsScreen extends Component {
    ...
    createUser = () => {
        ...
        const {customer:{ details, socialDetails}} = this.props.route.params.userData;
        ...
        if ((firstName !== "" || lastName !== "") && prefLanguage) {
            const url = "https://sit.l8r.in/profile-service/api/v1/customers/details/update";
    ...
    render() {
        return (
            ...
            <View style={styles.container}>
                <View>
                    <TouchableOpacity style={{ width: 48, height: 48, alignItems: "center", justifyContent: "center" }} onPress={() => this.props.navigation.goBack()}>
