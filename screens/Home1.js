    ...
    if (allPermissions) {
      ...
      if (!this.props.route.params.existUser) {
        this.props.navigation.navigate('Otp', {
          ...
          tempAuthToken: this.props.route.params.tempAuthToken,
          verification_key: this.props.route.params.verification_key,
        });
      } else {
    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        <View
          ...
          <View
            style={{width: '20%', marginLeft: 20, justifyContent: 'center'}}>
            <Image
              style={{
                width: 39,
                height: 39,
